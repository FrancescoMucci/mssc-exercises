...
\newcommand{\mycopyright}{\includegraphics[width=1.25cm]{copyright/by.png} 
...
\include{2-chapters/esercizi-parte-1}

\include{2-chapters/esercizi-parte-2}

\include{2-chapters/esercizi-parte-3}

%---------------------APPENDIX---------------------------------
\appendix
\include{3-appendix/a-induction}
